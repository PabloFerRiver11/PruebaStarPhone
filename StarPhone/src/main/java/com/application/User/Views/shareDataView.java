...
@PageTitle("Compartir Datos")
@Route(value = "/compartirdatos", layout = menu.class)
public class shareDataView extends VerticalLayout {
    ...
    public shareDataView(AuthenticatedUser authenticatedUser, MobileLineService mobileService) {
        ...
        confirmar = new Button("Compartir datos");
        confirmar.addClassName("activebutton");
        confirmar.addClickListener(e -> onShare());
        // ---------------------------
        ...
        titleDelete = new H3("Compartir datos");
    ...
    public void onShare() {
        if (Contrato.getValue() != null && linea.getValue() != null) {
            mobileService.share(linea.getValue());
