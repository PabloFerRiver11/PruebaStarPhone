...
@AnonymousAllowed
// TODO: @RolesAllowed({"MARKETING", "FINANCE", "CUSTOMERSUPPORT", "ADMIN"}) +
// import jakarta.annotation.security.RolesAllowed;
@CssImport("./styles/styles.css")
@PageTitle("Menu Admin")
@Route(value = "/menuadmin")
public class menuDepartments extends AppLayout {
    ...
    public menuDepartments(AuthenticatedUser authenticatedUser, AccessAnnotationChecker accessChecker) {
