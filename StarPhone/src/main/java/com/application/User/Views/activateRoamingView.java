...
@PageTitle("Activar Roaming")
@Route(value = "/activarroaming", layout = menu.class)
public class activateRoamingView extends VerticalLayout {
    ...
    public activateRoamingView(AuthenticatedUser authenticatedUser, MobileLineService mobileService) {
        ...
        confirmar = new Button("Activar");
        confirmar.addClassName("activebutton");
        confirmar.addClickListener(e -> onActivate());
        // ---------------------------
        ...
        titleDelete = new H3("Activar Roaming");
        ...
        bodyDiv = new VerticalLayout(Contrato, linea, confirmar);
    ...
    public void onActivate() {
        if (Contrato.getValue() != null && linea.getValue() != null) {
            mobileService.activateRoaming(linea.getValue());
            Notification.show("Roaming activado");
